...
** conkeror
   - content-policy rules are confusing and badly-documented
     this might help? https://github.com/thorkill/config-conkeror/blob/master/dot.conkerorrc/200-contentPolicy.js
