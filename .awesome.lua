...
util.spawn("awsetbg /home/phil/docs/images/9and9.jpg")
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ modkey,           }, "b", function ()
         ...
         -- change screen, but place the mouse over a window, not the panel
         mouse.coords({x = mouse.coords().x + 128,
                       y = mouse.coords().y + 128})
   end),
